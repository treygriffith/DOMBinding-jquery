...
// Some attributes are really properties, and need to be set as such
// this is based on the documentation at http://api.jquery.com/prop/
var props = ['selectedIndex', 'tagName', 'nodeName', 'nodeType', 'ownerDocument', 'defaultChecked', 'defaultSelected', 'disabled', 'checked'];

/**
 * Return the value of an property on a DOM element
 * @param  {String} name Name of property
 * @return {String}      Attribute value
 */
DOMBinding.prototype.getProp = function(name) {

	if(~props.indexOf(name)) {
 ...
 */
DOMBinding.prototype.setProp = function(name, val) {
...
/**
 * Trigger a DOM event
 * @param  {String} evt Event to emit
 * @return {DOMBinding}     DOMBinding that just emitted the event
 */
DOMBinding.prototype.emit = function(evt) {
